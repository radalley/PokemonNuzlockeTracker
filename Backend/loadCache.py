...
POKE_LOCS_CACHE_DIR = Path("seed_cache/pokemon_locs")
POKE_LOCS_CACHE_DIR.mkdir(parents=True, exist_ok=True)
...
# POKE_LOC_URL = 'https://pokeapi.co/api/v2/pokemon/##/encounters'
POKE_LOC_URL = 'https://pokeapi.co/api/v2/pokemon/'
